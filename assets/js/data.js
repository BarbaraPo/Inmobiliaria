const propiedades_venta= [
    {
        ...
        descripcion: 'Cómodo departamento en el corazón de la ciudad.',
    ...
    },
    {
        ...
        src: 'https://nexdom.racc.es/wp-content/uploads/2021/03/casa-espacios-abiertos-1.jpg',
    ...
    {
        nombre: 'Loft Moderno',
        src: 'https://st.depositphotos.com/40292480/54084/i/450/depositphotos_540846036-stock-photo-rendering-modern-apartment-gallery-kitchen.jpg',
        descripcion: 'Loft moderno y elegante con excelente iluminación.',
    ...
    },
    {
        ...
        src: 'https://planner5d.com/blog/content/images/2024/03/apartamento.estudio.9-1.jpg',
        descripcion: 'Estudio compacto ideal para estudiantes.',
    ...
    {
        nombre: 'Residencia Lujosa',
        src: 'https://img10.naventcdn.com/avisos/9/01/43/26/58/08/360x266/1453984512.jpg?isFirstImage=true',
        descripcion: 'Residencia de lujo con alberca y jardín.',
